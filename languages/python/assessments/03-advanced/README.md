...
```bash
python scripts/automation.py check-checkpoint --language python --kind assessment --level 03-advanced --solution
```
...
```bash
python scripts/automation.py check-checkpoint --language python --kind assessment --level 03-advanced
```
