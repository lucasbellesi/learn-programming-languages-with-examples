...
```bash
python scripts/automation.py check-checkpoint --language python --kind project --level 04-expert --solution
```
...
```bash
python scripts/automation.py check-checkpoint --language python --kind project --level 04-expert
```
