...
```bash
python scripts/automation.py check-checkpoint --language python --kind project --level 02-core --solution
```
...
```bash
python scripts/automation.py check-checkpoint --language python --kind project --level 02-core
```
