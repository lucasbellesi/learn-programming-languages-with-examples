...
~~~bash
python scripts/automation.py run-module --module-path languages/python/04-expert/concurrency-basics
~~~
...
```bash
python scripts/automation.py check-exercise --language python --level 04-expert --module concurrency-basics --exercise 01
```
