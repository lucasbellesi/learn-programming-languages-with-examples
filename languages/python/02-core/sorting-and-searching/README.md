...
~~~bash
python scripts/automation.py run-module --module-path languages/python/02-core/sorting-and-searching
~~~
...
```bash
python scripts/automation.py check-exercise --language python --level 02-core --module sorting-and-searching --exercise 01
```
