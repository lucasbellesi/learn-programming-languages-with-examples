...
~~~bash
python scripts/automation.py run-module --module-path languages/csharp/03-advanced/structs-and-classes
~~~
...
```bash
python scripts/automation.py check-exercise --language csharp --level 03-advanced --module structs-and-classes --exercise 01
```
