...
~~~bash
python scripts/automation.py run-module --module-path languages/csharp/03-advanced/inheritance-and-polymorphism
~~~
...
```bash
python scripts/automation.py check-exercise --language csharp --level 03-advanced --module inheritance-and-polymorphism --exercise 01
```
