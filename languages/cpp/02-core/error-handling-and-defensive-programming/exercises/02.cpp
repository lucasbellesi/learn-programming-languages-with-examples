/*
Exercise Guide:
 * languages/cpp/02-core/error-handling-and-defensive-programming/exercises/02.cpp
Goal: Solve the
 * task defined in this module's README Exercise Specs.
Build: g++ -std=c++17 -Wall -Wextra
 * -pedantic languages/cpp/02-core/error-handling-and-defensive-programming/exercises/02.cpp -o
 * 02_exercise
