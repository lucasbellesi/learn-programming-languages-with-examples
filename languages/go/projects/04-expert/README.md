...
```bash
python scripts/automation.py check-checkpoint --language go --kind project --level 04-expert --solution
```
...
```bash
python scripts/automation.py check-checkpoint --language go --kind project --level 04-expert
```
