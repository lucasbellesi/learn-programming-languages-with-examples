...
~~~bash
python scripts/automation.py run-module --module-path languages/go/02-core/input-validation
~~~
...
```bash
python scripts/automation.py check-exercise --language go --level 02-core --module input-validation --exercise 01
```
