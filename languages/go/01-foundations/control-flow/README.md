...
~~~bash
python scripts/automation.py run-module --module-path languages/go/01-foundations/control-flow
~~~
...
```bash
python scripts/automation.py check-exercise --language go --level 01-foundations --module control-flow --exercise 01
```
