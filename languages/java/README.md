...
This track currently covers `01-foundations` as a Java 21 MVP. Core, advanced, expert, projects, and assessments are planned for later iterations.

- 8/8 foundations modules implemented.
- 0/6 core modules implemented.
...
- Start by comparing Java foundations with the C#, Go, Python, TypeScript, and C++ foundations modules.
