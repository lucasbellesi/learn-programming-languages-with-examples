...
```bash
python scripts/automation.py check-checkpoint --language java --kind project --level 01-foundations --solution
```
...
```bash
python scripts/automation.py check-checkpoint --language java --kind project --level 01-foundations
```
