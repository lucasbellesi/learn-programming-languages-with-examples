...
| C# | 01-foundations, 02-core, 03-advanced, 04-expert (partial) | 8/8 foundations modules, 6/6 core modules, 5/5 advanced modules, 2/5 expert modules, 2/4 projects, 2/4 assessments | Advanced parity complete, expert rollout in progress |
